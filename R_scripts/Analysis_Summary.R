...
#------
source("/Users/charlotteuden/Desktop/trees/data/LPJ-GUESS_output/GRC_FSM/FSM_negative_GCR_positive/cleanup.R")
...
wit <- read.csv("/Users/charlotteuden/Desktop/trees/Historic_Fire_New_England/data/witness_trees/witness_treees_PFTs.csv")[,-1]
head(wit)
...
# 4. Once best value for GRC and FSM (lowest SSR) has been found, map fire porbabilities with best fit
...
# 3. rbind() all SSR 'maps'. For each girdpoint, find the lowest SSR:
